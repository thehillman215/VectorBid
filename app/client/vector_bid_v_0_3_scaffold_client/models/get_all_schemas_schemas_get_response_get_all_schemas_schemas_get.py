...
if TYPE_CHECKING:
    from ..models.get_all_schemas_schemas_get_response_get_all_schemas_schemas_get_additional_property import (
        GetAllSchemasSchemasGetResponseGetAllSchemasSchemasGetAdditionalProperty,
    )


T = TypeVar("T", bound="GetAllSchemasSchemasGetResponseGetAllSchemasSchemasGet")
...
class GetAllSchemasSchemasGetResponseGetAllSchemasSchemasGet:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        get_all_schemas_schemas_get_response_get_all_schemas_schemas_get = cls()

        additional_properties = {}
        for prop_name, prop_dict in d.items():
            additional_property = GetAllSchemasSchemasGetResponseGetAllSchemasSchemasGetAdditionalProperty.from_dict(
                prop_dict
            )
