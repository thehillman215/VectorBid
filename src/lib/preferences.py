...
FLYING_PERSONAS = {
    "family_first": {
        ...
        "fas fa-home",
        "description":
        "Maximize time at home with family and consistent schedule",
        "preferences":
        """I prioritize family time above all else. I want:
...
- Avoid reserve flying - need predictable schedule"""
    ...
    "money_maker": {
        ...
        "fas fa-dollar-sign",
        "description":
        "Maximize pay through high-credit trips and optimal scheduling",
        "preferences":
        """I want to maximize my monthly earnings. I prefer:
...
- Willing to work weekends for premium pay"""
    ...
    "commuter_friendly": {
        ...
        "Commuter Friendly",
        "description":
        "Optimize for easy commuting with flexible departure times",
        "icon":
        "fas fa-plane-departure",
        "preferences":
        """As a commuting pilot, I need schedule flexibility:
...
- Avoid same-day connections when commuting"""
    ...
    "quality_of_life": {
        ...
        "fas fa-heart",
        "description":
        "Balance work and personal time with reasonable schedules",
        "preferences":
        """I seek work-life balance and reasonable schedules:
...
- Moderate credit hours (not maximum, not minimum)"""
    ...
    "reserve_avoider": {
        ...
        "description":
        "Prioritize holding a line to avoid reserve duty",
        "preferences":
        """My top priority is avoiding reserve and holding a line:
...
def get_preference_summary(profile):
    ...
    return '\n'.join(
        summary_parts) if summary_parts else "Standard preferences."
