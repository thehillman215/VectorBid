...
api_v1.add_url_rule('/pbs/generate',
                   view_func=PBSGeneratorAPI.as_view('pbs_generate'))

api_v1.add_url_rule('/personas',
                   view_func=PersonasAPI.as_view('personas'))

api_v1.add_url_rule('/bid-packets',
                   view_func=BidPacketsAPI.as_view('bid_packets'))

api_v1.add_url_rule('/health',
                   view_func=HealthCheckAPI.as_view('health'))
