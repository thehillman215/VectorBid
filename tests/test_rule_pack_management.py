"""
Rule pack management system tests.
...
class TestRulePackValidation:
    ...
    def test_rule_pack_version_format_validation(self, rule_pack_validator):
        ...
        for version in valid_versions:
            assert rule_pack_validator.validate_version_format(version), f"Version {version} should be valid"
        
        for version in invalid_versions:
            assert not rule_pack_validator.validate_version_format(version), f"Version {version} should be invalid"
    ...
    def test_rule_pack_airline_code_validation(self, rule_pack_validator):
        ...
        for airline in valid_airlines:
            assert rule_pack_validator.validate_airline_code(airline), f"Airline {airline} should be valid"
        
        for airline in invalid_airlines:
            assert not rule_pack_validator.validate_airline_code(airline), f"Airline {airline} should be invalid"
...
class TestRulePackLoading:
    ...
    def test_rule_pack_yaml_loading(self, temp_rule_pack_file, sample_rule_pack):
        ...
        with open(temp_rule_pack_file, 'r') as f:
