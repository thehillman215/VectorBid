...
from app.rules_engine.dsl import DSLParseError, DSLParser, DSLSecurityError
...
class TestDSLParserWhitelist:
    ...
    def test_whitelisted_attribute_access(self):
        ...
        whitelist = {"pairing": {"duty_hours", "rest_hours"}, "ctx": {"pilot_id"}}
        parser = DSLParser(whitelist)
...
class TestDSLParserPerformance:
    ...
    def test_single_rule_eval_performance(self):
        ...
        whitelist = {"obj": {"duty_hours", "rest_hours", "legs", "redeye"}}
        parser = DSLParser(whitelist)
...
class TestDSLParserIntegration:
    ...
    def test_rule_pack_compilation(self):
        ...
        yaml_obj = {
            ...
            "soft": [{"id": "REST_PREFERENCE", "score": "obj.rest_hours >= 10", "weight": 0.8}],
        }
...
pytestmark = [pytest.mark.dsl, pytest.mark.rules_engine, pytest.mark.unit]
