...
from app.rules_engine import RulePackValidator, compile_rule_pack
...
class TestRulePackLoading:
    ...
    def test_rule_pack_health_integration(self):
        ...
        from app.rules_engine import pack_registry_health, pack_status
...
pytestmark = [pytest.mark.rules_engine, pytest.mark.integration]
