...
class TestRulePackModels:
    ...
    def test_hard_rule_creation(self):
        ...
        rule = HardRule(
            id="TEST_RULE", predicate=test_predicate, message="Test rule message", severity="ERROR"
        )
    ...
    def test_soft_rule_creation(self):
        ...
        rule = SoftRule(id="TEST_SCORE", score=test_score, weight=0.5, bounds=(0.0, 1.0))
    ...
    def test_derived_rule_creation(self):
        ...
        rule = DerivedRule(id="TEST_DERIVED", outputs={"computed_field": int}, expr=test_expr)
...
class TestRulePackCompiler:
    ...
    def test_compile_rule_pack_minimal(self):
        ...
        yaml_obj = {"airline": "UAL", "version": "2025.08", "effective_start": "2025-08-01"}
...
class TestRulePackValidator:
    ...
    def test_validate_inputs_no_violations(self):
        ...
        hard_rule = HardRule(id="TEST_RULE", predicate=always_pass, message="Test rule")
    ...
    def test_validate_inputs_with_violations(self):
        ...
        hard_rule = HardRule(id="TEST_RULE", predicate=always_fail, message="Test rule failed")
    ...
    def test_validate_schedule(self):
        ...
        hard_rule = HardRule(
            id="SCHEDULE_RULE", predicate=schedule_rule, message="Schedule validation failed"
        )
    ...
    def test_validate_export(self):
        ...
        hard_rule = HardRule(
            id="EXPORT_RULE", predicate=export_rule, message="Export validation failed"
        )
...
pytestmark = [pytest.mark.rules_engine, pytest.mark.unit]
